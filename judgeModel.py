...
stopwords = [
    ...
    "이제 다시 이야기 시작합니다.",
    "이번 내용은 꽤 긴데요.",
    "그래도 고지가 머지 않았으니 조금만 참고 이어가보죠.",
    "이제 마지막 이야기",
    "입니다.",
    "발언을 인용하면서 이만 줄입니다.",
    "이번 챕터는 여기서 줄이죠",
    "해야 한다는점을 상기하면서 이만 줄이도록 하겠습니다.",
    "내친김에",
    "어찌보면",
    "모쪼록",
    "이라 함은",
...
def calculate_knowledge_probability(encoded_text, input_text):
    ...
    matched_words = sum(
        [
            len([word for word in sentence if word in tokenizer.word_index])
            for sentence in input_processed
        ]
    )
